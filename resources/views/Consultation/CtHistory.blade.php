        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <x-history-controls :route="route('Consultation.CtHistory')" />
            ...
            <a href="{{ route('Consultation.CtOverallHistory') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
...
function updateCompletionStatus(appointmentId, isCompleted) {
    fetch(`/consultation/update-completion/${appointmentId}`, {
        method: 'POST',
        headers: {
