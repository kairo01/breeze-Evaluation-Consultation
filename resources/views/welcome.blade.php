...
<body class="bg-gray-100 text-gray-900 antialiased">
    ...
    <div class="absolute bottom-10 w-full text-center"> <!-- Adjusted from 'bottom-16' to 'bottom-10' -->
        <p class="text-sm text-white">Developed by:</p>
        <ul class="text-sm text-white font-semibold">
            <li>Abundia Rostelyn Jane</li>
            <li>Escat Denn Harenz</li>
            <li>Peralta Karl Allan</li>
        </ul>
    </div>
