...
class DpOverallHistoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('DepartmentHead.DpOverallHistory', compact('programs'));
    }
    ...
    public function showProgramHistory(Request $request, $program)
    {
        ...
        return view('DepartmentHead.DpProgramHistory', compact('program', 'courses'));
    }
